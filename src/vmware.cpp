...
#include "HostWrapper.hpp"

#if 0
/* static */ Napi::Object VIXClient::Init(Napi::Env env, Napi::Object exports) {
...
VIXClient::VIXClient(const Napi::CallbackInfo& info)
	: Napi::ObjectWrap<VIXClient>(info) {
	// 0: VMX Path
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
	// TODO: Set VIX constants that calling code should use
	// This won't be much (.. i hope) but we should still do it

	//exports.Set("")

	vix::VixHost::Init(env, exports);
